<header x-data="{ open: false, dropdownOpen: false, dropdownPetunjukOpen: false }"
                ...
                <div @click.away="dropdownOpen = false" class="relative">
                    ...
                    <div x-show="dropdownOpen" x-transition
                        ...
                        <a href="{{ route('informasi-pendaftaran') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Info Pendaftaran</a>
                        <a href="{{ route('informasi-biaya') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Info Biaya</a>
                        <a href="{{ route('informasi-fasilitas') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Info Fasilitas</a>
                    </div>
                </div>

                {{-- Dropdown Petunjuk --}}
                <div @click.away="dropdownPetunjukOpen = false" class="relative">
                    <button @click="dropdownPetunjukOpen = !dropdownPetunjukOpen"
                        class="flex items-center text-gray-700 hover:text-green-600">
                        <span>Petunjuk</span>
                        <svg class="h-5 w-5 ml-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                    ...
                    <div x-show="dropdownPetunjukOpen" x-transition
                        class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20">
                        <a href="{{ route('petunjuk-pendaftaran') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Petunjuk Pendaftaran</a>
                        <a href="{{ route('petunjuk-pembayaran') }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Petunjuk Pembayaran</a>
                    </div>
                </div>
