{{-- File: resources/views/components/admin/faq/edit-faq-modal.blade.php --}}

@props(['topics'])

<div
    {{-- Modal ini dikontrol oleh state 'editModalOpen' dan 'faqToEdit' dari parent component (faq.blade.php) --}}
...
>
    ...
    >
        ...
        {{-- Form: Pastikan faqToEdit tidak null sebelum render form --}}
        <template x-if="faqToEdit">
            <form :action="`/admin/faq/${faqToEdit.id}`" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div x-data="{
                            open: false,
                            selectedTopicId: faqToEdit.faq_topic_id || '',
                    ...
                    <div>
                        ...
                        <input type="text" name="pertanyaan" :value="faqToEdit.pertanyaan" class="w-full px-3 py-2 mt-1 text-gray-700 bg-gray-100 border-0 rounded-md focus:ring-2 focus:ring-[#028579] focus:bg-white" placeholder="Tulis pertanyaan di sini...">
                    ...
                    <div>
                        ...
                        {{-- Menggunakan x-text untuk mengisi value textarea --}}
                        <textarea name="jawaban" rows="6" class="w-full px-3 py-2 mt-1 text-gray-700 bg-gray-100 border-0 rounded-md focus:ring-2 focus:ring-[#028579] focus:bg-white" placeholder="Tulis jawaban lengkap di sini..." x-text="faqToEdit.jawaban"></textarea>
                ...
                <div class="flex items-center justify-end p-5 space-x-3 border-t bg-gray-50 rounded-b-lg">
                    <button type="button" @click="editModalOpen = false" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
                        Batal
                    </button>
