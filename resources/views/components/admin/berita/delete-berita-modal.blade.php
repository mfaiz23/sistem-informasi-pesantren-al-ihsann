    ...
    >
        <div class="text-center">
            ...
            <div class="mt-2 text-gray-600">
                ...
                {{-- Menampilkan kutipan judul berita yang akan dihapus --}}
                <p x-text="beritaToDelete ? `&ldquo;${beritaToDelete.judul.substring(0, 100)}...&rdquo;` : ''" class="mt-2 text-sm italic font-medium text-gray-800 bg-gray-100 rounded-md p-2"></p>
        ...
        <div class="mt-6 flex justify-center space-x-4">
            {{-- Tombol Batal --}}
            <button @click="deleteModalOpen = false; beritaToDelete = null"
            ...
            {{-- Form Hapus --}}
            <form x-show="beritaToDelete" :action="beritaToDelete ? `/admin/berita/${beritaToDelete.id}` : ''" method="POST" class="w-full sm:w-auto">
                @csrf
                @method('DELETE')
                <button type="submit"
