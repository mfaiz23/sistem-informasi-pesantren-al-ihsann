    ...
    <div x-show="deleteModalOpen" x-transition @click.outside="deleteModalOpen = false"
        ...
        <div class="text-center">
            ...
            <div class="mt-2 text-gray-600">
                ...
                <p x-text="userToDelete ? `Nama: ${userToDelete.name}` : ''" class="mt-2 text-sm italic font-medium text-gray-800 bg-gray-100 rounded-md p-2"></p>
        ...
        <div class="mt-6 flex justify-center space-x-4">
            {{-- Tombol Batal --}}
            <button @click="deleteModalOpen = false; userToDelete = null"
            ...
            <form x-show="userToDelete" :action="userToDelete ? `/admin/users/${userToDelete.id}` : ''" method="POST" class="w-full sm:w-auto">
                @csrf
                @method('DELETE')
                <button type="submit"
