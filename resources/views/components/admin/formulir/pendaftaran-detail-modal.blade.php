<div x-show="modalOpen" x-cloak
    ...
    <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200">
            ...
            <button @click="modalOpen = false" class="text-gray-500 hover:text-gray-700 focus:outline-none"
                aria-label="Tutup">
        ...
        <div class="flex-grow p-4 md:p-6 overflow-y-auto" x-show="selectedSantri">
            ...
            <div
                class="mb-6 pb-6 border-b border-gray-200 flex flex-col items-center md:flex-row md:items-start md:space-x-6">
                <div class="flex-shrink-0 mb-4 md:mb-0">
                    <div
                        class="flex items-center justify-center w-20 h-20 bg-green-100 rounded-full text-green-700 text-3xl font-bold">
                        <span
                            x-text="selectedSantri.nama_panggilan ? selectedSantri.nama_panggilan.slice(0, 1) + selectedSantri.nama_panggilan.slice(1, 2) : 'N/A'"></span>
                    </div>
                </div>
                <div class="text-center md:text-left flex-1">
                    <h3 class="text-2xl font-bold text-gray-900"
                        x-text="selectedSantri.user && selectedSantri.user.name ? selectedSantri.user.name : 'N/A'">
                    </h3>
                    <p class="text-sm text-gray-600 mb-2"
                        x-text="selectedSantri.user ? selectedSantri.user.email : 'N/A'"></p>
                    ...
                    <div class="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                        ...
                        <div class="flex flex-col items-center md:items-start">
                            ...
                            <span class="text-sm font-medium text-gray-800"
                                x-text="new Date(selectedSantri.created_at).toLocaleDateString('id-ID')"></span>
                        </div>
                        <div class="flex flex-col items-center md:items-start">
            ...
            <div class="mb-6 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"
                            x-text="selectedSantri.tanggal_lahir ? new Date(selectedSantri.tanggal_lahir).toLocaleDateString('id-ID') : 'N/A'">
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900"
                            x-text="selectedSantri.user && selectedSantri.user.no_telp ? selectedSantri.user.no_telp : 'N/A'">
                        </p>
                    </div>
                    <div>
            ...
            <div class="mb-6 pb-6 border-b border-gray-200"
                x-show="selectedSantri.kategori_pendaftaran === 'Non-Reguler'">
                <h4 class="text-lg font-semibold text-gray-800 mb-4">Kartu Indonesia Pintar (KIP)</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Nomor Kartu Indonesia Pintar
                            (KIP)</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.kip_document ? selectedSantri.kip_document.no_kip : 'N/A'"></p>
                    </div>
                    <div>
            ...
            <div class="mb-6 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.negara ? selectedSantri.alamat.negara : 'Indonesia'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Provinsi</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.provinsi ? selectedSantri.alamat.provinsi : 'N/A'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Kota/Kabupaten</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.kota_kabupaten ? selectedSantri.alamat.kota_kabupaten : 'N/A'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Kecamatan</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.kecamatan ? selectedSantri.alamat.kecamatan : 'N/A'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Desa/Kelurahan</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.desa_kelurahan ? selectedSantri.alamat.desa_kelurahan : 'N/A'">
                        </p>
                    </div>
                    <div class="md:col-span-2 lg:col-span-4">
                        <span class="block text-sm font-semibold text-gray-600">Alamat Lengkap</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.alamat && selectedSantri.alamat.alamat_lengkap ? selectedSantri.alamat.alamat_lengkap : 'N/A'">
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Nama Lengkap</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.parent && selectedSantri.parent.nama_lengkap ? selectedSantri.parent.nama_lengkap : 'N/A'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">No Handphone</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.parent && selectedSantri.parent.no_telp ? selectedSantri.parent.no_telp : 'N/A'">
                        </p>
                    </div>
                    <div class="md:col-span-2">
                        <span class="block text-sm font-semibold text-gray-600">Alamat</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.parent && selectedSantri.parent.alamat ? selectedSantri.parent.alamat : 'N/A'">
                        </p>
                    </div>
                    <div>
                        <span class="block text-sm font-semibold text-gray-600">Hubungan Keluarga</span>
                        <p class="text-gray-900"
                            x-text="selectedSantri.parent && selectedSantri.parent.hubungan_keluarga ? selectedSantri.parent.hubungan_keluarga : 'N/A'">
                        </p>
                    </div>
                </div>
            </div>

            {{-- === DOKUMEN PENDUKUNG (VIEW ONLY) === --}}
            <div class="mb-6 pb-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {{-- 1. Scan KTP --}}
                    <div
                        class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center">
                        <span class="text-sm font-semibold text-gray-600 mb-3">Scan KTP</span>

                        <template x-if="selectedSantri.dokumen_ktp">
                            {{-- Area Preview (Klik untuk Lihat) --}}
                            <div class="h-40 w-full bg-gray-200 rounded overflow-hidden flex items-center justify-center border cursor-pointer hover:bg-gray-300 transition relative group"
                                @click="window.open(`{{ asset('storage') }}/${selectedSantri.dokumen_ktp}`, '_blank')"
                                title="Klik untuk melihat file">

                                {{-- Jika PDF --}}
                                <template x-if="selectedSantri.dokumen_ktp.toLowerCase().endsWith('.pdf')">
                                    <div
                                        class="text-red-500 flex flex-col items-center group-hover:scale-110 transition duration-300">
                                ...
                                {{-- Jika Gambar --}}
                                <template x-if="!selectedSantri.dokumen_ktp.toLowerCase().endsWith('.pdf')">
                                    <img :src="`{{ asset('storage') }}/${selectedSantri.dokumen_ktp}`"
                                        class="w-full h-full object-contain group-hover:opacity-80 transition duration-300"
                                        alt="Preview KTP">
                                </template>
                                ...
                                <div
                                    ...
                                    <span
                                        class="bg-white bg-opacity-90 px-2 py-1 rounded text-xs font-semibold shadow opacity-0 group-hover:opacity-100 transition duration-300">Buka
                                        File</span>
                                </div>
                            </div>
                        </template>
                        ...
                        <template x-if="!selectedSantri.dokumen_ktp">
                            <div
                                class="flex flex-col items-center justify-center h-40 w-full text-gray-400 border-2 border-dashed border-gray-300 rounded">
                    ...
                    <div
                        class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center">
                        <span class="text-sm font-semibold text-gray-600 mb-3">Scan KK</span>

                        <template x-if="selectedSantri.dokumen_kk">
                            <div class="h-40 w-full bg-gray-200 rounded overflow-hidden flex items-center justify-center border cursor-pointer hover:bg-gray-300 transition relative group"
                                @click="window.open(`{{ asset('storage') }}/${selectedSantri.dokumen_kk}`, '_blank')"
                                title="Klik untuk melihat file">

                                <template x-if="selectedSantri.dokumen_kk.toLowerCase().endsWith('.pdf')">
                                    <div
                                        class="text-red-500 flex flex-col items-center group-hover:scale-110 transition duration-300">
                                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <template x-if="!selectedSantri.dokumen_kk.toLowerCase().endsWith('.pdf')">
                                    <img :src="`{{ asset('storage') }}/${selectedSantri.dokumen_kk}`"
                                        class="w-full h-full object-contain group-hover:opacity-80 transition duration-300"
                                        alt="Preview KK">
                                </template>
                    ...
                    <div
                        class="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center">
                        <span class="text-sm font-semibold text-gray-600 mb-3">Ijazah Terakhir</span>

                        <template x-if="selectedSantri.dokumen_ijazah">
                            <div class="h-40 w-full bg-gray-200 rounded overflow-hidden flex items-center justify-center border cursor-pointer hover:bg-gray-300 transition relative group"
                                @click="window.open(`{{ asset('storage') }}/${selectedSantri.dokumen_ijazah}`, '_blank')"
                                title="Klik untuk melihat file">

                                <template x-if="selectedSantri.dokumen_ijazah.toLowerCase().endsWith('.pdf')">
                                    <div
                                        class="text-red-500 flex flex-col items-center group-hover:scale-110 transition duration-300">
                                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <template x-if="!selectedSantri.dokumen_ijazah.toLowerCase().endsWith('.pdf')">
                                    <img :src="`{{ asset('storage') }}/${selectedSantri.dokumen_ijazah}`"
                                        class="w-full h-full object-contain group-hover:opacity-80 transition duration-300"
                                        alt="Preview Ijazah">
                                </template>
        ...
        <div class="p-4 border-t border-gray-200 flex justify-end">
            <button @click="modalOpen = false"
                class="px-6 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 focus:outline-none">Tutup</button>
        </div>
    </div>
</div>