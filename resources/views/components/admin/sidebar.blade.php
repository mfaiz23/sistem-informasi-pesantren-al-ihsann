...
>
    ...
    <nav class="mt-10 px-4">
        {{-- Menggunakan url() dan request()->is() untuk active state --}}
        <x-admin.nav-link href="{{ url('/dashboard_admin') }}" :active="request()->is('dashboard_admin')">
            <x-slot name="icon">
        ...
        <x-admin.nav-link href="{{ url('/manajemen_pengguna') }}" :active="request()->is('manajemen_pengguna')">
            <x-slot name="icon">
        ...
        <x-admin.nav-link href="{{ url('/pendaftaran_santri') }}" :active="request()->is('pendaftaran_santri')">
            <x-slot name="icon">
        ...
        <x-admin.nav-link href="{{ url('/keuangan') }}" :active="request()->is('keuangan')">
            <x-slot name="icon">
